...
public class PersonajeController {
    ...
    public ResponseEntity<List<PersonajeDTO>> getDetailsByFilters(
            ...
            @RequestParam(required = false) Set<Long> peliculaSerie,
            @RequestParam(required = false, defaultValue = "ASC") String order
    ){
        List<PersonajeDTO> personajes = this.personajeService.getByFilters(nombre, edad, peso, peliculaSerie,order);
